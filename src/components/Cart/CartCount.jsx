...
const CartCount = ({ onCartToggle }) => {
    return (
        <>
            ...
            px-3 sticky top-0 right-0 left-0 w-full gap-3">
            ...
            <div>
                <h1 className='text-base font-medium text-slate-900'> Your Cart <span className="bg-theme-cart
                rounded px-1 py-0.5 text-slate-100 font-normal text-xs">(Items)</span></h1>
            </div>
